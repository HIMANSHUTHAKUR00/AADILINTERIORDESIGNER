            ...
            <div className='about-wrapper'>
                ...
                <div className='about-paragraph'>
                    <motion.p
                      ...
                      viewport={{once: true}}
                    >With over 6 years of experience, we bring a skilled eye for details, coupled with flawless execution, to ensure your home or commercial space is a reflection of your individual style. Whether it be a new construction or renovation projects, no matter the scope or size, AADIL Interiors specializes in custom design solutions tailored specifically for each project. Whether you’re looking for residential or commercial design services, you can trust that your vision will be expertly crafted under our team.</motion.p>
                </div>
            </div>
      </div>
    </div>
